...
export class Migration20240829125616_create_classroom_enrollment_table extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'create table "classrooms" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "title" varchar(255) not null, "subject" varchar(255) not null, "class_time" time(0) not null, "days" text check ("days" in (\'Monday\', \'Tuesday\', \'Wednesday\', \'Thursday\', \'Friday\', \'Saturday\', \'Sunday\')) not null, "teacher_id" int not null);',
    );
